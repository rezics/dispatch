...
export const TaskPlainInputCreate = t.Object(
  {
    ...
    basePriority: t.Optional(t.Integer()),
    ...
    maxHoldExpiresAt: t.Optional(__nullable__(t.Date())),
    finishedAt: t.Optional(__nullable__(t.Date())),
    error: t.Optional(__nullable__(t.String())),
    recurrenceInterval: t.Optional(__nullable__(t.Integer())),
    recurrenceJitter: t.Optional(__nullable__(t.Integer())),
  },
  { additionalProperties: false },
);
      ...
      t.Object(
        {
          ...
          maxHoldExpiresAt: t.Date(),
          finishedAt: t.Date(),
          error: t.String(),
          recurrenceInterval: t.Integer(),
          recurrenceJitter: t.Integer(),
          createdAt: t.Date(),
        },
        { additionalProperties: false },
      ),
  ...
  t.Object(
    {
      ...
      maxHoldExpiresAt: t.Boolean(),
      finishedAt: t.Boolean(),
      error: t.Boolean(),
      recurrenceInterval: t.Boolean(),
      recurrenceJitter: t.Boolean(),
      createdAt: t.Boolean(),
  ...
  t.Object(
    {
      ...
      basePriority: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      ...
      maxHoldExpiresAt: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      ...
      recurrenceInterval: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      recurrenceJitter: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
